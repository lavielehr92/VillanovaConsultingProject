...
print("Testing with hypothetical data:")
m_score_test = calculate_m_score_manual(
    receivables_current=100, revenue_current=1000, gross_profit_current=300, current_assets_current=500,
    total_assets_current=1000, ppe_current=200, depreciation_current=50, sga_expenses_current=100,
    current_liabilities_current=300, long_term_debt_current=200, net_income_current=100,
    nonoperating_income_current=10, operating_cash_flow_current=150,
    receivables_previous=80, revenue_previous=900, gross_profit_previous=270, current_assets_previous=450,
    total_assets_previous=950, ppe_previous=180, depreciation_previous=45, sga_expenses_previous=90,
    current_liabilities_previous=280, long_term_debt_previous=180, net_income_previous=90,
    nonoperating_income_previous=5, operating_cash_flow_previous=130,
    debug=True
)
print(f"Test M-Score: {m_score_test:.4f}")
...
def main():
    ...
    try:
        ...
        long_term_debt_current = balance_sheet.loc['Long Term Debt', current_date]
        ...
        long_term_debt_previous = balance_sheet.loc['Long Term Debt', previous_date]
